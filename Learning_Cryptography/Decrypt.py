...
source_path = input("File for decryption: ")
...
# اگر صرفا بخواهیم پیغام از رمز درآمده
# را مشاهده کرده و آن‌را در داخل فایل نریزیم
# از دستوارت ذیل استفاده می‌کنیم
...
target_path = f"{location}{source_path_parts[1]}.dec"
